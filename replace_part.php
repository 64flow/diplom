...
<?php
    ...
    <h2>Назначение замены детали</h2>
    <form action="replace_part1.php?plane_id=<?php echo urlencode($plane_id); ?>&part_id=<?php echo urlencode($part_id); ?>" method="post">
    ...
    <div class="form-row">
        ...
        <br>
            ...
            <button type="submit" class="button-sp">Назначить замену детали</button>
...
form.addEventListener('submit', function(event) {
    ...
    if (hasUnfinishedWork) {
        alert('На эту деталь замена уже назначена');
        event.preventDefault();
        return;
    }
