...
try {
    ...
    $sql = "INSERT INTO works (name, start_date, finish_date, required_number_of_empoyees, plane_id, part_id)
    VALUES ('Ремонт детали', ?, ?, ?, ?, ?)";
$stmt = $db->prepare($sql);
...
echo '<script type="text/javascript"> alert("Ремонт детали назначен.");</script>';
